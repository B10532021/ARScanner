...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneVisualizer : MonoBehaviour
    {
        ...
        public void Initialize(DetectedPlane plane, List<Vector3> planePoints, Vector3 planeCenter)
        {
            m_DetectedPlane = plane;
            /*m_MeshVertices.Clear();
            for(int i = 0; i < planePoints.Count; i++)
            {
                m_MeshVertices.Add(planePoints[i]);
            }*/
            m_PlaneCenter = planeCenter;
            m_MeshRenderer.material.SetColor("_GridColor", Color.white);
            m_MeshRenderer.material.SetFloat("_UvRotation", Random.Range(0.0f, 360.0f));
        ...
        private void _UpdateMeshIfNeeded()
        {
            ...
            Vector3 planeNormal = Vector3.Cross(m_MeshVertices[1] - m_MeshVertices[0], m_MeshVertices[2] - m_MeshVertices[0]);
